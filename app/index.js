...
var instance = 
{
	init() 
	{
		...
		this.changeLevelButton 		= document.getElementById('changeLevel')
		...
		this.callIncoming 			= multiplayer.callIncoming.bind(this)
		this.startVideoCall 		= multiplayer.startVideoCall.bind(this)
		this.endVideoCall 			= multiplayer.endVideoCall.bind(this)
		this.acceptVideoCall 		= multiplayer.acceptVideoCall.bind(this)
